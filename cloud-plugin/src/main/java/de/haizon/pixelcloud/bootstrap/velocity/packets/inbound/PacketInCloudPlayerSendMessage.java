 ...
 */
public class PacketInCloudPlayerSendMessage extends PacketReceiveFunction {

    public PacketInCloudPlayerSendMessage() {
        super(PacketType.PLAYER_SEND_MESSAGE.name());
    }
